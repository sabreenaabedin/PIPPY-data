...
file_ids = ["135818293109976","1582733551821102"] #Group 1: Acne and Pimple Solutions
...
for i in file_ids:
    ...
    def scrapeFacebookPageFeedComments(page_id, access_token):
        with open('facebook_comments_{}.csv'.format(i), 'w' , newline = "", encoding='utf-8') as file:
            w = csv.writer(file)
            ...
            with open('facebook_statuses_{}.csv'.format(i), 'r', encoding='utf-8') as csvfile:
    ...
    if __name__ == '__main__':
        scrapeFacebookPageFeedComments(i, access_token)
